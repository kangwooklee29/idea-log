"""
flask_server/blueprints/api/views.py
"""
...
def fetch_categories():
    ...
    return jsonify([
        cat.to_dict()
        for cat in category_dao.fetch_by_user_id(session.get('profile')['id'])
    ])
...
def write_message():
    ...
    if message_dao.write_message(message=message,
...
def update_category():
    ...
    if category_dao.update_category(name, category_id,
